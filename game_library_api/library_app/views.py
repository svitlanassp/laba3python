...
class BaseViewSet(viewsets.ViewSet):
    ...
    pagination_class = StandardPagination  # Додаємо за замовчуванням
    ...
    def list(self, request):
        ...
        if self.pagination_class:
            ...
            # Обробляємо page_size параметр з запиту
    ...
    def list(self, request):
        ...
        if self.pagination_class:
            try:
                ...
                pass  # Якщо пагінація не вдалась - повертаємо все
...
class LibraryViewSet(BaseViewSet):
    ...
    def list(self, request):
        ...
        if user_id:
            try:
                ...
                if library:
                    ...
                    return Response([serializer.data])  # ← Це не пагінується
                else:
                    return Response([])
            except Exception as e:
        ...
        # Якщо немає user_id - використовуємо базову пагінацію
        return super().list(request)  # ← Викликає BaseViewSet.list()
